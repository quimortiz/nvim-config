...
require('packer').startup(function(use)
  ...
  use 'quimortiz/vim-avim'
  use 'quimortiz/vim-toggle'
...
vim.keymap.set('n', '<leader>gg', "*:A<CR>gg n", { silent = true })

require("luasnip.loaders.from_vscode").lazy_load()
-- require("luasnip.loaders.from_vscode").lazy_load()
require("luasnip.loaders.from_vscode").lazy_load({ paths = { "/home/quim/.config/nvim/my_cool_snippets/" } })
...
local on_attach = function(_, bufnr)
  ...
  -- nmap('vgd', ':vsp lua vim.lsp.buf.definition, '[G]oto [D]efinition')
  nmap('gr', require('telescope.builtin').lsp_references, '[G]oto [R]eferences')
  nmap('gI', vim.lsp.buf.implementation, '[G]oto [I]mplementation')

  nmap( 'sgd', '<cmd>split | lua vim.lsp.buf.definition()<CR>' )
  nmap( 'vgd', '<cmd>vsplit | lua vim.lsp.buf.definition()<CR>' )
...
require('onedark').setup {
  ...
  highlights = {
    ["@Terminal"] = { fg = '$bright_orange', bg = '#00ff00', fmt = 'bold' },
  }
}
...
-- command! -nargs=* VT vertical split | terminal <args>


vim.api.nvim_set_keymap("t", "<Esc>", "<C-\\><C-n>", {})

vim.api.nvim_set_keymap("n", "<F1>",
  ":let $VIM_DIR=expand('%:p:h')<CR>: split | terminal cd $VIM_DIR && bash<CR> <C-\\><C-n>:resize 20<CR>",
  { silent = true })

vim.api.nvim_set_keymap("n", "<F2>",
  ":let $VIM_DIR=expand('%:p:h')<CR>: vertical split | terminal cd $VIM_DIR && bash<CR> <C-\\><C-n>:resize 20<CR>",
  { silent = true })
...
dap.adapters.python = {
  type = 'executable';
  command = '/home/quim/debugpy/bin/python';
...
dapui.setup {
  ...
  -- icons = { expanded = "EX", collapsed = "CO", current_frame = "CF" },
  -- controls = {
...
-- Debuging: think about using nvim-dap-ui
